...
const audioKeyboardClose = document.querySelector('audio[data-audio="keyboardCloseOpen"]');
...
console.log(item)
        ...
        switch (true) {
            ...
            case (item.dataset.key === 'backspace'):
                ...
                break;
            case (item.dataset.key=== '⌨ ▼'):
                audioKeyboardClose.currentTime = 0;
                audioKeyboardClose.play();
                break;
    ...
    windowEvent() {
        ...
        window.addEventListener("keydown", (e) => {
            ...
            [].forEach.call(this.rootHtmlButton, item => {
                if (this.isAlphabet === 'rus' && item.innerHTML.toLowerCase() === e.key.toLowerCase()) {
                    this.audioPlay(item)
                } else if (item.dataset.key.toLowerCase() === e.key.toLowerCase() || e.code.toLowerCase() === item.dataset.key.toLowerCase() ) {
                    this.audioPlay(item)
                }
